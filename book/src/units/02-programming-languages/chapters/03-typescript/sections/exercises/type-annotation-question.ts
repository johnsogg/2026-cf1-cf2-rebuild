...
const typeAnnotationQuestion: MultipleChoiceExerciseProps = {
  ...
  prompt: 'Which of the following correctly annotates a function parameter as a number in TypeScript?',
  options: [
  ...
  correct: 1,
  hints: ['TypeScript uses a colon after the parameter name to specify its type.'],
}
